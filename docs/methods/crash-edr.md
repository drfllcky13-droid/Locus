...
The speed's accuracy is entered as a scale (%) and an offset (in the speed unit). It is systematic: every sample is off by the same factor and offset. The default ±1 km/h is the accuracy 49 CFR Part 563 requires of indicated vehicle speed.
